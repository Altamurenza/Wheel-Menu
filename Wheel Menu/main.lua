	...
	while true do
		...
		if WHEEL.GENERAL.SHOW then
			...
			if table.getn(WHEEL.GROUP[WHEEL.GENERAL.TAB[1]].CONTENT[WHEEL.GROUP[WHEEL.GENERAL.TAB[1]].OPTION.CURRENT]) > 0 and (IsButtonBeingPressed(WHEEL.GENERAL.KEY[4], 0) or IsButtonBeingPressed(WHEEL.GENERAL.KEY[5], 0)) then
				...
				if WHEEL.GENERAL.GAME.SOUND and table.getn(WHEEL.GROUP[WHEEL.GENERAL.TAB[1]].CONTENT[WHEEL.GROUP[WHEEL.GENERAL.TAB[1]].OPTION.CURRENT]) > 1 then
		...
		if WHEEL.GENERAL.SHOW then
			...
			for ID, PART in ipairs(WHEEL.COMPONENT.BACK.FILE) do
				...
				if not WHEEL.COMPONENT.BACK.COLOR.UTILITY[1] then
					DrawTexture2(WHEEL.COMPONENT.BACK.TEXTURE[PART..'_T'], WHEEL.COMPONENT.BACK.X, WHEEL.COMPONENT.BACK.Y, WHEEL.COMPONENT.BACK.SCALE * WHEEL.COMPONENT.BACK.TEXTURE[PART..'_R'], WHEEL.COMPONENT.BACK.SCALE, 0, WHEEL.COMPONENT.BACK.COLOR.RED[1], WHEEL.COMPONENT.BACK.COLOR.GREEN[1], WHEEL.COMPONENT.BACK.COLOR.BLUE[1], WHEEL.COMPONENT.BACK.COLOR.OPACITY[1])
				else
					DrawTexture2(WHEEL.COMPONENT.BACK.TEXTURE[PART..'_T'], WHEEL.COMPONENT.BACK.X, WHEEL.COMPONENT.BACK.Y, WHEEL.COMPONENT.BACK.SCALE * WHEEL.COMPONENT.BACK.TEXTURE[PART..'_R'], WHEEL.COMPONENT.BACK.SCALE, 0, ID == WHEEL.GROUP[WHEEL.GENERAL.TAB[1]].OPTION.CURRENT and WHEEL.COMPONENT.BACK.COLOR.RED[2] or WHEEL.COMPONENT.BACK.COLOR.RED[1], ID == WHEEL.GROUP[WHEEL.GENERAL.TAB[1]].OPTION.CURRENT and WHEEL.COMPONENT.BACK.COLOR.GREEN[2] or WHEEL.COMPONENT.BACK.COLOR.GREEN[1], ID == WHEEL.GROUP[WHEEL.GENERAL.TAB[1]].OPTION.CURRENT and WHEEL.COMPONENT.BACK.COLOR.BLUE[2] or WHEEL.COMPONENT.BACK.COLOR.BLUE[1], WHEEL.COMPONENT.BACK.COLOR.OPACITY[1])
				end
			end
			
			if table.getn(WHEEL.COMPONENT.BACK.SELECT) > 0 and WHEEL.COMPONENT.BACK.SELECT[WHEEL.GROUP[WHEEL.GENERAL.TAB[1]].OPTION.CURRENT] then
				if not WHEEL.COMPONENT.BACK.COLOR.UTILITY[2] then
					DrawTexture2(WHEEL.COMPONENT.BACK.TEXTURE[WHEEL.COMPONENT.BACK.SELECT[WHEEL.GROUP[WHEEL.GENERAL.TAB[1]].OPTION.CURRENT]..'_T'], WHEEL.COMPONENT.BACK.X, WHEEL.COMPONENT.BACK.Y, WHEEL.COMPONENT.BACK.SCALE * WHEEL.COMPONENT.BACK.TEXTURE[WHEEL.COMPONENT.BACK.SELECT[WHEEL.GROUP[WHEEL.GENERAL.TAB[1]].OPTION.CURRENT]..'_R'], WHEEL.COMPONENT.BACK.SCALE, 0, WHEEL.COMPONENT.BACK.COLOR.RED[1], WHEEL.COMPONENT.BACK.COLOR.GREEN[1], WHEEL.COMPONENT.BACK.COLOR.BLUE[1], WHEEL.COMPONENT.BACK.COLOR.OPACITY[1])
				else
					DrawTexture2(WHEEL.COMPONENT.BACK.TEXTURE[WHEEL.COMPONENT.BACK.SELECT[WHEEL.GROUP[WHEEL.GENERAL.TAB[1]].OPTION.CURRENT]..'_T'], WHEEL.COMPONENT.BACK.X, WHEEL.COMPONENT.BACK.Y, WHEEL.COMPONENT.BACK.SCALE * WHEEL.COMPONENT.BACK.TEXTURE[WHEEL.COMPONENT.BACK.SELECT[WHEEL.GROUP[WHEEL.GENERAL.TAB[1]].OPTION.CURRENT]..'_R'], WHEEL.COMPONENT.BACK.SCALE, 0, WHEEL.COMPONENT.BACK.COLOR.RED[2], WHEEL.COMPONENT.BACK.COLOR.GREEN[2], WHEEL.COMPONENT.BACK.COLOR.BLUE[2], WHEEL.COMPONENT.BACK.COLOR.OPACITY[1])
				end
			end
			
			DrawTexture2(WHEEL.COMPONENT.BACK.TEXTURE.MID_T, WHEEL.COMPONENT.BACK.X, WHEEL.COMPONENT.BACK.Y, WHEEL.COMPONENT.BACK.SCALE * WHEEL.COMPONENT.BACK.TEXTURE.MID_R, WHEEL.COMPONENT.BACK.SCALE, 0, WHEEL.COMPONENT.BACK.COLOR.RED[1], WHEEL.COMPONENT.BACK.COLOR.GREEN[1], WHEEL.COMPONENT.BACK.COLOR.BLUE[1], WHEEL.COMPONENT.BACK.COLOR.OPACITY[1])
					...
					for ID, CONTENT in ipairs(WHEEL.GROUP[1].CONTENT[CATEGORY]) do
						if ID == WHEEL.GROUP[1].SELECT[CATEGORY][1] then
							if CATEGORY == WHEEL.GROUP[1].OPTION.CURRENT then
								if CONTENT.NAME == WHEEL.COMPONENT.FRONT.GRAPHIC.ICON[1] then
									WHEEL.COMPONENT.FRONT.GRAPHIC.ICON[2] = WHEEL.COMPONENT.FRONT.GRAPHIC.ICON[2] + 0.002 > WHEEL.COMPONENT.FRONT.SCALE + 0.005 and WHEEL.COMPONENT.FRONT.SCALE + 0.005 or WHEEL.COMPONENT.FRONT.GRAPHIC.ICON[2] + 0.002
								else
									WHEEL.COMPONENT.FRONT.GRAPHIC.ICON = {CONTENT.NAME, WHEEL.GENERAL.ANIM.ICON and WHEEL.COMPONENT.FRONT.SCALE - 0.01 or WHEEL.COMPONENT.FRONT.SCALE + 0.005, WHEEL.COMPONENT.FRONT.SCALE + 0.005}
								end
								
								DrawTexture2(WHEEL.COMPONENT.FRONT.TEXTURE['ICON_01_'..CONTENT.ICON..'_T'], WHEEL.COMPONENT.FRONT.ICON_X[WHEEL.GENERAL.TAB[1]][CATEGORY], WHEEL.COMPONENT.FRONT.ICON_Y[WHEEL.GENERAL.TAB[1]][CATEGORY], WHEEL.COMPONENT.FRONT.GRAPHIC.ICON[2] * WHEEL.COMPONENT.FRONT.TEXTURE['ICON_01_'..CONTENT.ICON..'_R'], WHEEL.COMPONENT.FRONT.GRAPHIC.ICON[2], 0, WHEEL.COMPONENT.FRONT.COLOR.ICON.RED, WHEEL.COMPONENT.FRONT.COLOR.ICON.GREEN, WHEEL.COMPONENT.FRONT.COLOR.ICON.BLUE, WHEEL.COMPONENT.FRONT.COLOR.ICON.OPACITY)
								...
								DRAW_TEXT('Release ['..(WHEEL.GENERAL.KEY[6] and 'L3' or (WHEEL.GENERAL.KEY[1] == 'VK_TAB' and 'TAB' or WHEEL.GENERAL.KEY[1]))..'] to Use', 0.6, WHEEL.COMPONENT.FRONT.INFO_X[3], WHEEL.COMPONENT.FRONT.INFO_Y[3], 'center', WHEEL.COMPONENT.FRONT.COLOR.TEXT.OPACITY, 'Arial')
								...
								for STAT = 1, 4 do
									...
									if CONTENT.NAME == WHEEL.COMPONENT.FRONT.GRAPHIC.STAT[STAT][1] then
										WHEEL.COMPONENT.FRONT.GRAPHIC.STAT[STAT][2] = WHEEL.COMPONENT.FRONT.GRAPHIC.STAT[STAT][2] - 0.075 < WHEEL.COMPONENT.FRONT.GRAPHIC.STAT[STAT][3] and WHEEL.COMPONENT.FRONT.GRAPHIC.STAT[STAT][3] or WHEEL.COMPONENT.FRONT.GRAPHIC.STAT[STAT][2] - 0.075
									else
										WHEEL.COMPONENT.FRONT.GRAPHIC.STAT[STAT] = {CONTENT.NAME, WHEEL.GENERAL.ANIM.STAT and 1 or (100-CONTENT.STAT[STAT])/100, (100-CONTENT.STAT[STAT])/100}
									end
									SetTextureBounds(WHEEL.COMPONENT.FRONT.TEXTURE['BAR_01_'..STAT..'_T'], 1 - WHEEL.COMPONENT.FRONT.GRAPHIC.STAT[STAT][2], 0, 1, 1)
									DrawTexture(WHEEL.COMPONENT.FRONT.TEXTURE['BAR_01_'..STAT..'_T'], WHEEL.COMPONENT.FRONT.BAR_X + (1 - WHEEL.COMPONENT.FRONT.GRAPHIC.STAT[STAT][2]) * (WHEEL.COMPONENT.FRONT.SCALE + 0.0145), WHEEL.COMPONENT.FRONT.BAR_Y[STAT], (WHEEL.COMPONENT.FRONT.SCALE + 0.0145) * WHEEL.COMPONENT.FRONT.GRAPHIC.STAT[STAT][2], (WHEEL.COMPONENT.FRONT.SCALE + 0.0145) / WHEEL.COMPONENT.FRONT.TEXTURE['BAR_01_'..STAT..'_R'], WHEEL.COMPONENT.FRONT.COLOR.BAR.RED[1], WHEEL.COMPONENT.FRONT.COLOR.BAR.GREEN[1], WHEEL.COMPONENT.FRONT.COLOR.BAR.BLUE[1], WHEEL.COMPONENT.FRONT.COLOR.BAR.OPACITY)
								end
							else
								DrawTexture2(WHEEL.COMPONENT.FRONT.TEXTURE['ICON_01_'..CONTENT.ICON..'_T'], WHEEL.COMPONENT.FRONT.ICON_X[WHEEL.GENERAL.TAB[1]][CATEGORY], WHEEL.COMPONENT.FRONT.ICON_Y[WHEEL.GENERAL.TAB[1]][CATEGORY], (WHEEL.COMPONENT.FRONT.SCALE - 0.01) * WHEEL.COMPONENT.FRONT.TEXTURE['ICON_01_'..CONTENT.ICON..'_R'], WHEEL.COMPONENT.FRONT.SCALE - 0.01, 0, WHEEL.COMPONENT.FRONT.COLOR.ICON.RED, WHEEL.COMPONENT.FRONT.COLOR.ICON.GREEN, WHEEL.COMPONENT.FRONT.COLOR.ICON.BLUE, WHEEL.COMPONENT.FRONT.COLOR.ICON.OPACITY)
							end
							DRAW_TEXT(CONTENT.AMMO == 0 and '1/1' or ItemGetCurrentNum(NI_AMMO[WHEEL.GROUP[1].SELECT[CATEGORY][2]] or WHEEL.GROUP[1].SELECT[CATEGORY][2])..'/'..CONTENT.AMMO, 0.8 + (CATEGORY == WHEEL.GROUP[1].OPTION.CURRENT and 0 or -0.2), WHEEL.COMPONENT.FRONT.AMMO_X[CATEGORY], WHEEL.COMPONENT.FRONT.AMMO_Y[CATEGORY] + (CATEGORY == WHEEL.GROUP[1].OPTION.CURRENT and 0 or 0.004), 'center', CONTENT.AMMO == -1 and 0 or WHEEL.COMPONENT.FRONT.COLOR.TEXT.OPACITY, 'Arial')
						end
					end
				end
					...
					for ID, CONTENT in ipairs(WHEEL.GROUP[2].CONTENT[CATEGORY]) do
						if ID == WHEEL.GROUP[2].SELECT[CATEGORY][1] then
							if CATEGORY == WHEEL.GROUP[2].OPTION.CURRENT then
								...
								DRAW_TEXT('Release ['..(WHEEL.GENERAL.KEY[6] and 'L3' or (WHEEL.GENERAL.KEY[1] == 'VK_TAB' and 'TAB' or WHEEL.GENERAL.KEY[1]))..'] to Apply', 0.6, WHEEL.COMPONENT.FRONT.INFO_X[3], WHEEL.COMPONENT.FRONT.INFO_Y[3], 'center', WHEEL.COMPONENT.FRONT.COLOR.TEXT.OPACITY, 'Arial')
								...
								for STAT = 1, 4 do
									...
									SetTextureBounds(WHEEL.COMPONENT.FRONT.TEXTURE['BAR_02_'..STAT..'_T'], 1 - WHEEL.COMPONENT.FRONT.GRAPHIC.STAT[STAT][2], 0, 1, 1)
					...
					for ID, CONTENT in ipairs(WHEEL.GROUP[3].CONTENT[CATEGORY]) do
						if CONTENT.NAME == WHEEL.GROUP[3].SELECT[CATEGORY][2] then
							if CATEGORY == WHEEL.GROUP[3].OPTION.CURRENT then
								...
								DRAW_TEXT('Release ['..(WHEEL.GENERAL.KEY[6] and 'L3' or (WHEEL.GENERAL.KEY[1] == 'VK_TAB' and 'TAB' or WHEEL.GENERAL.KEY[1]))..'] to '..CONTENT.ACTION, 0.6, WHEEL.COMPONENT.FRONT.INFO_X[3], WHEEL.COMPONENT.FRONT.INFO_Y[3], 'center', WHEEL.COMPONENT.FRONT.COLOR.TEXT.OPACITY, 'Arial')
							else
								DrawTexture2(WHEEL.COMPONENT.FRONT.TEXTURE['ICON_03_'..CONTENT.ICON..'_T'], WHEEL.COMPONENT.FRONT.ICON_X[2][CATEGORY], WHEEL.COMPONENT.FRONT.ICON_Y[2][CATEGORY], (WHEEL.COMPONENT.FRONT.SCALE - 0.01) * WHEEL.COMPONENT.FRONT.TEXTURE['ICON_03_'..CONTENT.ICON..'_R'], WHEEL.COMPONENT.FRONT.SCALE - 0.01, 0, WHEEL.COMPONENT.FRONT.COLOR.ICON.RED, WHEEL.COMPONENT.FRONT.COLOR.ICON.GREEN, WHEEL.COMPONENT.FRONT.COLOR.ICON.BLUE, WHEEL.COMPONENT.FRONT.COLOR.ICON.OPACITY)
							end
						end
...
SETUP_WHEEL = function()
	...
	WHEEL = {
		...
		COMPONENT = {
			BACK = {
				PATH = 'COMPONENT', FILE = {'BOT_M', 'BOT_L', 'TOP_L', 'TOP_M', 'TOP_R', 'BOT_R'}, SELECT = {}, TEXTURE = {}, SCALE = 0.65, OPACITY = 180, X = 0.5, Y = 0.5, COLOR = {UTILITY = {true, false}, RED = {0, 140, 0}, GREEN = {0, 100, 0}, BLUE = {0, 0, 0}, OPACITY = {180, 150}}, FILTER = 0,
			},
			FRONT = {
				...
				ICON_X = {[1] = {0.500, 0.383, 0.378, 0.500, 0.623, 0.623}, [2] = {0.500, 0.381, 0.380, 0.500, 0.620, 0.620}}, AMMO_X = {0.500, 0.400, 0.365, 0.500, 0.635, 0.595}, INFO_X = {0.500, 0.425, 0.500}, DOT_X = {[2] = {0.491, 0.502}, [3] = {0.485, 0.496, 0.507}}, BAR_X = 0.49,
				ICON_Y = {[1] = {0.745, 0.615, 0.390, 0.255, 0.390, 0.615}, [2] = {0.742, 0.620, 0.385, 0.258, 0.395, 0.620}}, AMMO_Y = {0.757, 0.665, 0.445, 0.275, 0.445, 0.665}, INFO_Y = {0.355, 0.443, 0.615}, DOT_Y = 0.14, BAR_Y = {0.4155, 0.4505, 0.4857, 0.5205},
				GRAPHIC = {ICON = {'', 0.06, 0.075}, STAT = {{'', 0, 0}, {'', 0, 0}, {'', 0, 0}, {'', 0, 0}}},
			},
		},
		GENERAL = {
			KEY = {'Q', 0, 1, 11, 13, false}, TAB = {1, 3, {}}, GAME = {MOTION = true, SOUND = true, FILTER = {SHOW = true, FADE = true}}, ANIM = {ICON = true, STAT = true}, SHOW = false, RULE = true, CONFIG = nil, PRESET = nil
		},
	}
	shared.WHEEL = {
		GROUP = {
	...
	if not IsConfigMissing(WHEEL.GENERAL.CONFIG) then
		...
		for ID, KEY in ipairs({'wheel_menu', 'prev_tab', 'next_tab', 'prev_category', 'next_category'}) do
			...
			if ID == 1 then
				if not tonumber(WHEEL.GENERAL.KEY[1]) and WHEEL.GENERAL.KEY[1] ~= 'VK_TAB' then
		...
		for ID, KEY in ipairs({'icon', 'stat'}) do
			WHEEL.GENERAL.ANIM[string.upper(KEY)] = GetConfigBoolean(WHEEL.GENERAL.CONFIG, 'animated_'..KEY, WHEEL.GENERAL.ANIM[string.upper(KEY)])
		end
	...
	for _, PART in ipairs(WHEEL.COMPONENT.BACK.FILE) do
		WHEEL.COMPONENT.BACK.TEXTURE[PART..'_T'] = CreateTexture((WHEEL.GENERAL.PRESET and 'PRESET/'..WHEEL.COMPONENT.BACK.PATH..'/'..PART or 'COMPONENT/W_'..PART)..'.png')
		WHEEL.COMPONENT.BACK.TEXTURE[PART..'_R'] = GetTextureDisplayAspectRatio(WHEEL.COMPONENT.BACK.TEXTURE[PART..'_T'])
	end
	
	if table.getn(WHEEL.COMPONENT.BACK.SELECT) > 0 then
		for _, PART in ipairs(WHEEL.COMPONENT.BACK.SELECT) do
			WHEEL.COMPONENT.BACK.TEXTURE[PART..'_T'] = CreateTexture('PRESET/'..WHEEL.COMPONENT.BACK.PATH..'/'..PART..'.png')
			WHEEL.COMPONENT.BACK.TEXTURE[PART..'_R'] = GetTextureDisplayAspectRatio(WHEEL.COMPONENT.BACK.TEXTURE[PART..'_T'])
		end
	end
...
MissionCleanup = function()
	...
	----------------------------------------------------------
	-- # RESTORE FUNCTIONS AND CLEAR GLOBAL/SHARED VARIABLES #
	----------------------------------------------------------
	
	_G.PlayerWeaponHudLock = shared.gPWHL[2]
	shared.gPWHL = nil
	_G.PlayerSetControl = shared.gPSCT[2]
	shared.gPSCT = nil
	_G.CameraFade = shared.gCF[2]
	shared.gCF = nil
	_G.MissionSucceed = shared.gMS
	shared.gMS = nil
	_G.MissionFail = shared.gMF
	shared.gMF = nil
	_G.ClothingBuildPlayer = shared.gCBP
	shared.gCBP = _G.ClothingBuildPlayer
	_G.ToggleHUDComponentVisibility = shared.gTHCV
	shared.gTHCV = nil
	_G.GetStickValue = shared.gGSV
	shared.gGSV = nil
	_G.PauseSimulation = shared.gPUS[2]
	_G.UnpauseSimulation = shared.gPUS[3]
	shared.gPUS = nil
	_G.SoundPause = shared.gPCS[2]
	_G.SoundContinue = shared.gPCS[3]
	shared.gPCS = nil
	
	WHEEL, shared.WHEEL, NI_WEAPON, NI_AMMO, X, Y, Z = nil, nil, nil, nil, nil, nil, nil
